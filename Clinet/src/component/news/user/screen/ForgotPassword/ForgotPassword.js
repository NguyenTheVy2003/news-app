    ...
    <KeyboardAvoidingView style={styles.container}>
        ...
        <View>
          <View style={styles.container_forgotPassword}>
            ...
            <Text style={styles.text_txt}>
              Don’t worry! it happens. Please select the email or number
              ...
              <View style={styles.container_email}>
                <View style={styles.container_text_email}>
                  <View style={styles.ic_email_sms}>
                    <Image
                      style={styles.ic}
                      source={require('../../../../../media/ic_email.png')}
                    />
                  </View>
                  ...
                  <TouchableOpacity>
                    <Image
                      ...
                      source={require('../../../../../media/ic_radioBt.png')}
                    />
                  </TouchableOpacity>
                </View>
              </View>
              <View style={styles.container_email}>
                <View style={styles.container_text_email}>
                  <View style={styles.ic_email_sms}>
                    <Image
                      style={styles.ic}
                      source={require('../../../../../media/ic_sms.png')}
                    />
                  </View>
                  <View style={styles.container_txt_email_sms}>
                  ...
                  <TouchableOpacity>
                    <Image
                      style={{width: 20, height: 20, flexShrink: 0}}
                      source={require('../../../../../media/ic_radioBt_noClick.png')}
                    />
                  </TouchableOpacity>
                </View>
              </View>
      ...
      <View>
        <TouchableOpacity
          ...
          onPress={() => props.navigation.navigate('ForgotPassword2')}>
