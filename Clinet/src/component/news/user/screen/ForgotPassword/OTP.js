        ...
        <View style={styles.container}>
            <View style={styles.container_otp}>
                ...
                <View style={styles.conatiner_otp_txt}>
                    <Text style={[styles.otp_txt, styles.otp_txt_1]}>OTP Verification</Text>
                    <Text style={styles.otp_txt}>Enter the OTP sent to +67-1234-5678-9</Text>
                </View>
                <View>
                    ...
                    <View style={styles.container_invalidOtp}>
                        <Image style={{ width: 16, height: 16, }} source={require('../../../../../media/ic_warning.png')} />
            ...
            <Text style={styles.txt_resendcode}>Resend code in <Text style={[styles.txt_resendcode, styles.txt_resendcode_1]}>56s</Text></Text>
