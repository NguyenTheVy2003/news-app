import { StyleSheet, Text, View, TouchableOpacity, TextInput, Image, Pressable, ToastAndroid, Alert, KeyboardAvoidingView, ScrollView } from 'react-native'
            ...
            >
                <View >
                    ...
                    <View style={styles.inputPasswordContainer}>
                        ...
                        <View style={styles.inputTextContainer}>
                            <TextInput style={styles.input}
                                ...
                                value={role}
                                onChangeText={(text => { setRole(Number) })} />
                        </View>
                    </View>
                    <View>
                    ...
                    <View style={styles.already}>
                        ...
                        <Pressable >
                            <Text onPress={() => props.navigation.navigate('Login')} style={[styles.already_text1, styles.already_login]}>Login</Text>
                        </Pressable>
                    </View>
                </View>
            </ScrollView>
