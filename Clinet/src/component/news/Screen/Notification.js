...
const Notification = (props) => {
    ...
    return (
        <View style={styles.conatiner}>
            ...
            {
                DaTaNotifi.map((item) => <ItemListNews key={item._id} data={item} />)
            }
...
const DaTaNotifi = [
    {
        "_id": "1",
        "title": "Pilot proposes to flight attendant girlfriend in front of passengers",
        ...
        "image": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSyhukHFdx5p-tLNBrU1j52IeYHmn3VlN3YRw&s",
        "createdAt": "1h ago",
        "createdBy": {
    ...
    {
        "_id": "3",
        "title": "BBC Director General Tim Davie has made protecting impartiality one of his major priorities. Oli",
        ...
        "image": "https://media.cnn.com/api/v1/images/stellar/prod/230223121345-bbc-director-general-tim-davie-1122-file.jpg?q=w_1110,c_fill/f_webp",
        "createdAt": "1 Day ago",
        "createdBy": {
            "_id": "63ac39aeedf7c80016c57a67",
            "name": "",
    ...
    {
        "_id": "4",
        "title": "Premier League club Nottingham Forest accuses refereeing official of supporting rival team after defeat",
        ...
        "image": "https://media.cnn.com/api/v1/images/stellar/prod/gettyimages-2149637911.jpg?c=16x9&q=h_653,w_1160,c_fill/f_webp",
