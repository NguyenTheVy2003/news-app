import { StyleSheet, Text, View, Image, FlatList, TouchableOpacity, Dimensions, ScrollView, TextInput, Pressable, ActivityIndicator } from 'react-native'
      ...
      //       source={{ uri: image }} /> */}
        <View style={styles.container_ItemList}>
          ...
          <View style={styles.content}>
            <Text numberOfLines={1} style={styles.ItemList_content_text}>{name}</Text>
            <Text style={{ marginTop: 2, fontSize: 16, fontWeight: '400', lineHeight: 24, letterSpacing: 0.12, color: '#000' }} numberOfLines={2}>{price}</Text>
