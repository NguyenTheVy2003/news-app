    ...
    <KeyboardAvoidingView style={styles.container}>
      ...
      >
        ...
        <View style={styles.container_add_cover_photo}>
          ...
          <TouchableOpacity onPress={openCamera}>
            <Image
              style={{width: 24, height: 24}}
              source={require('../../../media/ic_+.png')}></Image>
          </TouchableOpacity>
      ...
      <TouchableOpacity onPress={() => setShow(true)}>
        ...
        <View style={styles.container_text_input2}>
          <TextInput
            placeholder="Add news/Price"
            style={styles.textInput2}
            onChangeText={setprice}></TextInput>
        </View>
        <View style={styles.container_text_input2}>
          <TextInput
            placeholder="Add news/Quantity"
            style={styles.textInput2}
      ...
      <View style={styles.container_Pulish}>
        <View style={styles.container_Pulish_ic}>
          <Image
            source={require('../../../media/ic_Aa.png')}
            style={{width: 24, height: 24}}></Image>
          <Image
            source={require('../../../media/ic_Align_left.png')}
            style={{width: 24, height: 24, marginStart: 24}}></Image>
          <TouchableOpacity onPress={openPhotolibrary}>
            <Image
              source={require('../../../media/ic_Image.png')}
              style={{width: 24, height: 24, marginStart: 24}}></Image>
          </TouchableOpacity>
          <Image
        ...
        <TouchableOpacity
          style={styles.container_button_publish}
          onPress={dangTin}>
